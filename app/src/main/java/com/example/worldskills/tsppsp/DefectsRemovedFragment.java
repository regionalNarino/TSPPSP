...
public class DefectsRemovedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        plan=view.findViewById(R.id.planRemoved);
        dld=view.findViewById(R.id.dldRemoved);
        compile=view.findViewById(R.id.compileRemoved);
        ut=view.findViewById(R.id.utRemoved);
        pm=view.findViewById(R.id.pmRemoved);
        code=view.findViewById(R.id.codeRemoved);
    ...
    private void cargarResultados() {
        ...
        for (int i=0; i< fases.length; i++){
            try{
                String sql="select count(id) from defectlog where phaseremoved='"+fases[i]+"' and idproject="+ Variables.id;
